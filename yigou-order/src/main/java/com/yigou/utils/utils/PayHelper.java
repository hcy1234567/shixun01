package com.yigou.utils.utils;

import com.github.wxpay.sdk.WXPay;

import com.yigou.config.config.PayConfig;
import com.yigou.order.order.service.OrderService;
...
public class PayHelper {
    ...
    public String createPayUrl(Long orderId) {
        String key = "yigou.pay.url." + orderId;
        try {
        ...
        try {
            ...
            //回调地址，付款成功后的接口
            data.put("notify_url", "http://test.yigou.com/wxpay/notify");
            // 交易类型为扫码支付
